<%@ Page Title="Timetable" Language="C#" AutoEventWireup="true" MasterPageFile="~/Client.Master"  CodeBehind="Timetable.aspx.cs" Inherits="NaviGO.Users.Client.Timetable" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gvTimetable" runat="server" CssClass="table table-striped table-dark" AutoGenerateColumns="False" Font-Names="Calibri Light" Font-Size="Large" GridLines="Horizontal" HorizontalAlign="Center">
        <Columns>
            <asp:BoundField DataField="tripid" HeaderText="Trip No." />
    ...
    <div class="form-group" style="display:inline-block; margin-top:50px;" >
                <div style="display:block;float:left; padding:0px 10px 0px 20px" ><h4>Select Trip No.</h4>
                        <asp:ListBox ID="lstTripNo" runat="server" AutoPostBack="False" OnSelectedIndexChanged="lstTripNo_SelectedIndexChanged" CssClass="form-control"></asp:ListBox>
                    </div>
