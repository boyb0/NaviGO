<%@ Page Title="Home" Language="C#" AutoEventWireup="true" MasterPageFile="~/Client.Master"  CodeBehind="Home.aspx.cs" Inherits="NaviGO.Users.Client.Home" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display:inline-block; width:500px; border-style:dashed; border-width:1px; padding:20px;">
        ...
        <div style="display:inline-block; width:500px; border-style:dashed; border-width:1px; padding:20px; margin-left:119px">
        <h2>Your Card numbers</h2>
        <hr />
        <asp:ListBox ID="lstCardNumbers" runat="server" Width="400px" CssClass="form-control" ForeColor="Black" Font-Size="20px"></asp:ListBox>
        <br />
        <asp:Label runat="server" AssociatedControlID="tbNewCreditNo" CssClass=" control-label">New Card Number</asp:Label>
        <asp:TextBox runat="server" ID="tbNewCreditNo" TextMode="SingleLine" CssClass="form-control" EnableViewState="False" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="tbNewCreditNo"
                    CssClass="text-danger" Display="Dynamic" ErrorMessage="The credit number field is required." ValidationGroup="Group4" />
                <asp:RegularExpressionValidator runat="server" ControlToValidate="tbNewCreditNo"
                    CssClass="text-danger" Display="Dynamic" ErrorMessage="The card number should be 16 digits." ValidationExpression="\d{16}" ValidationGroup="Group4" />
        <br />        
        <asp:Button ID="btnAddCardNo" runat="server" Text="Add Card No." CssClass="btn btn-default" ValidationGroup="Group4" Font-Size="15px" EnableViewState="False" OnClick="btnAddCardNo_Click"  /> &nbsp;
        <asp:Button ID="btnDeleteCardNo" runat="server" Text="Delete" CssClass="btn btn-default" OnClick="btnDeleteCardNo_Click" />
    </div>
    </div>
