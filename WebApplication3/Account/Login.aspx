<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="NaviGO.Account.Login" Async="true" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    <h4>Use your NaviGO account to log in.</h4>
                    <hr />
        ...
        <div class="col-md-4">
            ...
            <br />
            <br />
            <asp:Label ID="lblMessage" runat="server" Font-Bold="True" Font-Size="22px" ForeColor="#F15864"></asp:Label>
        </div>
    </div>
</asp:Content>
